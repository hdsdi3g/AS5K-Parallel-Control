...
public class ControllerMode2 extends ControllerUpdater {
	...
	public void initialize() throws Exception {
		ApplicationMode2.channel1.appInitialize(this);
		ApplicationMode2.channel2.appInitialize(this);
	}
	...
	void onbtncueclick(ActionEvent event) {
		...
		ApplicationMode2.channel1.appCue(mediaid, takenum, showname, btncue, btnrec);
		ApplicationMode2.channel2.appCue(mediaid, takenum, showname, btncue, btnrec);
	}
	...
	void onbtnrecclick(ActionEvent event) {
		...
		ApplicationMode2.channel1.appRec(mediaid, _take, showname);
		ApplicationMode2.channel2.appRec(mediaid, _take, showname);
		takenum.setText(String.valueOf(_take + 1));
	}
	
	@FXML
	void onbtnstopclick(ActionEvent event) {
		ApplicationMode2.channel1.appStop();
		ApplicationMode2.channel2.appStop();
	}

...
public class ApplicationMode1 extends Application {
	
	static Serverchannel channel1;
	static Scene scene;
	
	public void start(Stage stage) throws IOException {
		stage.setTitle("AirSpeed Parallel Recorder - simple recorder mode");
		...
		Parent root = FXMLLoader.load(getClass().getResource("form-mode1.fxml"));

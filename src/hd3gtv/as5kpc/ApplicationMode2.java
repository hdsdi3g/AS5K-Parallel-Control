...
public class ApplicationMode2 extends Application {
	...
	public void start(Stage stage) throws IOException {
		stage.setTitle("AirSpeed Parallel Recorder - 2 recorders mode");
		...
		Parent root = FXMLLoader.load(getClass().getResource("form-mode2.fxml"));
